...
requirements = python3,kivy,yt-dlp,certifi,urllib3,requests,pycryptodome,mutagen,websockets,brotli,pyjnius,plyer
...
# (list) List of Java .jar files to add to the libs so that pyjnius can access their classes. Don't add jars that you do not need, since extra jars can slow down the build process. Functionality may be broken if their classes are missing.
...
# 1) android.add_assets = file1.txt,image.png,directory/
# 2) android.add_assets.1 = path/to/file1.txt
# 2) android.add_assets.2 = path/to/directory2/
#android.add_assets =

# (list) Put these files or directories in the apk res directory.
# The option may be used in 2 ways, the value may contain one or zero ':'
# Some examples:
...
# (bool) If True, bootstrap will always run (used for debugging purposes)
# p4a.bootstrap = sdl2
...
# Get a list of available identities: Xcode > Open Developer Tool > Keychain Access > Your certificates "
